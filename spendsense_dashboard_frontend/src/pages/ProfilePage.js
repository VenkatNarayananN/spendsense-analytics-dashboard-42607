          ...
          {warningBanner ? (
            <div
              ...
              style={{
                ...
                padding: "10px 12px",
                borderRadius: 12,
                border: "1px solid color-mix(in srgb, var(--ss-border-color) 65%, var(--ss-warn) 35%)",
                background:
                  "linear-gradient(135deg, color-mix(in srgb, var(--ss-card-bg) 85%, var(--ss-warn) 15%), color-mix(in srgb, var(--ss-card-bg) 92%, var(--ss-primary) 8%))",
                color: "var(--ss-text-primary)",
                display: "flex",
                gap: 10,
